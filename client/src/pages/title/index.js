      ...
      >
        ...
        >
          ...
          <Form.Item
            ...
            {...(errors && errors.find((error) => error.param === "policy")
              ? {
                  help: errors.find((error) => error.param === "policy").msg,
                  validateStatus: "error",
                }
              : null)}
          >
                        ...
                        <Col span={12}>
                          <Form.Item
                            rules={[
                              {
                                required: true,
                                message: "Ангын нэр оруулна уу.",
                              },
                            ]}
                          >
                            <Input placeholder="Content" size="large" />
                          </Form.Item>
                        </Col>
                        <Col span={12}>
                          <Form.Item
